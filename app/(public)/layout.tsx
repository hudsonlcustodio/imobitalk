...
export default async function PublicLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <IdiomaProvider locale={locale}>
      <div className="flex min-h-screen items-center justify-center bg-[radial-gradient(circle_at_top_left,rgba(123,63,164,0.10),transparent_34%),radial-gradient(circle_at_bottom_right,rgba(245,124,0,0.08),transparent_28%)] bg-background p-6">
