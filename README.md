...
>
> ```bash
> curl -fsSL https://raw.githubusercontent.com/hudsonlcustodio/imobitalk/main/hostgator-setup-kit/comecar.sh | bash
> ```
>
...
Abra uma [issue](https://github.com/hudsonlcustodio/imobitalk/issues/new/choose) — o template pede o que precisamos (ambiente, `/api/v1/health`, steps). Rodar `bash hostgator-setup-kit/healthcheck.sh` e colar a saída ajuda muito.

Pra **vulnerabilidades de segurança**, **NÃO abra issue pública** — use o [relato privado de vulnerabilidades](https://github.com/hudsonlcustodio/imobitalk/security/advisories/new). Detalhes em [`SECURITY.md`](SECURITY.md).
...
- **Suporte é comunitário e "as-is".** Dúvidas e bugs entram como
  [Issues](https://github.com/hudsonlcustodio/imobitalk/issues) ou
  [Discussions](https://github.com/hudsonlcustodio/imobitalk/discussions). Não há SLA nem
