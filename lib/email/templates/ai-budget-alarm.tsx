...
export function buildBudgetAlarmEmail(opts: BudgetAlarmEmailOptions): {
  ...
  const subject = `Alerta IA: orçamento atingiu ${pctStr} — IMOBI CRM`;
...
<body style="margin:0;padding:0;background:#f5f5f4;font-family:system-ui,-apple-system,Segoe UI,sans-serif;color:#1c1917">
  <div style="max-width:560px;margin:0 auto;padding:32px 24px">
    ...
    <p style="margin:24px 0">
      <a href="${opts.dashboardUrl}" style="display:inline-block;padding:12px 24px;background:#7B3FA4;color:#ffffff;border-radius:6px;text-decoration:none;font-weight:600">
