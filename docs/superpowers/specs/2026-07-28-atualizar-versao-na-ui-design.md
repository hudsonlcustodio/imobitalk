...
O app roda dentro de um container (`ghcr.io/hudsonlcustodio/imobitalk`) sem nenhum volume do host.
...
- Sobe `APP_IMAGE=ghcr.io/hudsonlcustodio/imobitalk:<versão>` em vez de `latest`.
