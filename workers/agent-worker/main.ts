...
if (!sentryDsn) {
  console.info('[telemetria] worker: Desligada (SENTRY_DSN vazio/off) — nenhum erro é enviado.');
} else {
  console.info('[telemetria] worker: Erros sendo enviados ao Sentry configurado pelo operador.');
}
