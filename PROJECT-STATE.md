...
- as alterações desta revisão passaram em install congelado, typecheck, lint, auditoria de
  dependências e testes focais; o CI do commit `0f036d7` passou integralmente;
...
Revisar e integrar o PR #6. Depois, configurar proteção da `main`, prover staging isolado,
executar migration/backup/smoke/restore e só então decidir uma primeira
