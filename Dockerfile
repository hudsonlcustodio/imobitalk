...
# IMOBI CRM — imagem de produção self-host (Next.js standalone).
...
LABEL org.opencontainers.image.source="https://github.com/hudsonlcustodio/imobitalk" \
      org.opencontainers.image.licenses="MIT" \
      org.opencontainers.image.title="IMOBI CRM"
